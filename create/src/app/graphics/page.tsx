  ...
  return (
    <div className="bg-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-3xl font-extrabold text-gray-900 mb-4">Graphics</h2>

        {/* Tagline */}
        <p className="text-lg text-gray-600 mb-8">
          For all your <span className="font-semibold text-gray-800">posters, logos, brochures, and flyers</span>
        </p>
